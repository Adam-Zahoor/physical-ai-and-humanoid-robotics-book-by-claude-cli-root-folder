...
class FlockingPatternDetector:
    ...
    def _calculate_alignment(self, agent_states: List[AgentState]) -> float:
        ...
        for vel in velocities:
            ...
            if speed > 0:
                # Normalize velocities and calculate dot product
                norm_vel = vel / speed
                norm_avg = avg_velocity / avg_speed
                alignment = np.dot(norm_vel, norm_avg)
